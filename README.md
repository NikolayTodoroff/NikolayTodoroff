...
## Projects
- [VM Lifecycle Azure Devops Infra](https://github.com/NikolayTodoroff/azure-vm-lifecycle-devops) — Terraform-provisioned Azure VM lifecycle automation platform using Azure DevOps, Ansible, Azure Automation Runbooks, Managed Identity, and Service Hooks to deploy, configure, maintain, and notify on a VM-based workload.
